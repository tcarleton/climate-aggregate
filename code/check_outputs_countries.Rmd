...
## files
weight_file  <- 'weights/brazil_muni_era5_area_crop_weights.csv'

temp_file <- 'output/brazil_muni_era5_temp_average_1990_2019_polynomial_5_area_crop_weights.csv'

prcp_file <- 'output/brazil_muni_era5_prcp_sum_1990_2019_polynomial_3_area_crop_weights.csv'

polygon_file <- 'shapefiles/BRA/geo2_br1980_2010.shp'
...
country_name <- "BRA"
low_temp_month <- 'month_07'
high_temp_month <- 'month_02'
spring_months <- c('month_11', 'month_12', 'month_01')
fall_months <- c('month_04', 'month_05', 'month_06')
low_prcp_m <- 'month_09'
dry_months <- c('month_08', 'month_09', 'month_10')
high_prcp_m <- 'month_12'
wet_months <- c('month_12', 'month_01', 'month_02')
plot_yrs <- seq(1990, 2019, by = 5)
...
country_areas <- country_shp %>% 
  mutate(poly_id = GEOLEVEL2) %>% 
  dplyr::select(poly_id)

if(country_name %in% c("USA", "BRA")) {
