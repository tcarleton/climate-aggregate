...
## files
weight_file  <- 'weights/kor_prov_era5_area_crop_weights.csv'

temp_file <- 'output/kor_prov_era5_temp_average_1983_2018_polynomial_5_area_crop_weights.csv'

prcp_file <- 'output/kor_prov_era5_prcp_sum_1983_2018_polynomial_3_area_crop_weights.csv'

polygon_file <- 'shapefiles/KOR/gadm36_KOR_1.shp'
...
poly1_plot <- ggplot() + 
  geom_line(data = out_2_crop_temp2, aes(x = month, y = order_1_avg, color = as.factor(poly_id), group = poly_id)) + 
  facet_wrap(~year) + 
