...
## files
weight_file  <- 'weights/usa_area_era5_area_crop_weights.csv'

temp_file <- 'output/usa_area_era5_temp_average_1968_2004_polynomial_5_area_crop_weights.csv'

prcp_file <- 'output/usa_area_era5_prcp_sum_1968_2004_polynomial_3_area_crop_weights.csv'

polygon_file <- 'shapefiles/USA/tl_2016_us_county_mortality.shp'
