...
years <- 2009:2020 # any sequence of years 1967:2020
...
input_polygons_name <- 'nzl_region_sp_check' # Name used in saving function outputs; should relate to the polygons used
