...
input_polygons <- read_sf(file.path(input_dir, "data", "shapefiles", "ECU", "gadm36_ECU_1.shp"))
...
input_polygons_name <- 'ecu_province' # Name used in saving function outputs; should relate to the polygons used
