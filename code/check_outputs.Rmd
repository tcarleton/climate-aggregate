...
poly1_plot <- ggplot() + 
  geom_line(data = out_2, aes(x = month, y = order_1, color = as.factor(poly_id), group = poly_id)) + 
  facet_wrap(~year) + 
  ...
  scale_y_continuous(expand = c(0,0),
                     limits = c(800,2400),
                     breaks = seq(800,2400,400)) + 
  labs(x = 'Month',
       y = 'Summed Monthly Temperature (First Order)') + 
  theme_bw() + 
  theme(legend.position = '')
