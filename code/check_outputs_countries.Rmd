...
## files
weight_file  <- 'weights/ecu_province_era5_area_crop_weights.csv'

temp_file <- 'output/ecu_province_era5_temp_average_1990_2018_polynomial_5_area_crop_weights.csv'

prcp_file <- 'output/ecu_province_era5_prcp_sum_1990_2018_polynomial_3_area_crop_weights.csv'

polygon_file <- 'shapefiles/ECU/gadm36_ECU_1.shp'
...
country_name <- "ECU"
low_temp_month <- 'month_09'
high_temp_month <- 'month_06'
spring_months <- c('month_11', 'month_12', 'month_01')
fall_months <- c('month_06', 'month_07', 'month_08')
low_prcp_m <- 'month_06'
dry_months <- c('month_06', 'month_07', 'month_08')
high_prcp_m <- 'month_04'
wet_months <- c('month_03', 'month_04', 'month_05')
plot_yrs <- seq(1990, 2018, by = 5)
