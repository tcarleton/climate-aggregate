...
input_polygons <- read_sf(file.path(input_dir, "data", "shapefiles", "IND", "IND_adm1.shp"))
...
years <- 1967:2013 # any sequence of years 1967:2020
...
input_polygons_name <- 'ind_states' # Name used in saving function outputs; should relate to the polygons used
