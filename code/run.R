...
years <- 1997:2013 # any sequence of years 1967:2020
...
id_var <- 'adm2_id' # Col name in the input_polygons shp that uniquely identifies each polygon 
...
input_polygons_name <- 'chl_area' # Name used in saving function outputs; should relate to the polygons used
