...
input_polygons <- read_sf(file.path(input_dir, "data", "shapefiles", "KOR", "gadm36_KOR_1.shp"))
...
years <- 1983:2018 # any sequence of years 1967:2020
...
input_polygons_name <- 'kor_prov' # Name used in saving function outputs; should relate to the polygons used
