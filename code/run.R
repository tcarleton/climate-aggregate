...
input_polygons <- read_sf(file.path(input_dir, "data", "shapefiles", "BRA", "geo2_br1980_2010.shp"))
...
years <- 1990:2019 # any sequence of years 1967:2020
...
id_var <- 'GEOLEVEL2' # Col name in the input_polygons shp that uniquely identifies each polygon 
...
input_polygons_name <- 'brazil_muni' # Name used in saving function outputs; should relate to the polygons used
